...
<head>
  ...
  <title>NusaDaya - Campaigns</title>
...
<body id="page-top">
  ...
  <!-- Campaign -->
  <section class="page-section" style="background-color: #a2f9a5; padding-top: 70px;">
    <div class="container">
      <div class="row" id="services">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase" >Campaign Page</h2>
