...
<head>
  ...
  <title>[Admin] NusaDaya</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.7 -->
  <link href="{{url('AdminLTE/css/bootstrap.min.css')}}" rel="stylesheet">
  <!-- Font Awesome -->
  <link href="{{url('AdminLTE/css/font-awesome.min.css')}}" rel="stylesheet">
  <!-- Ionicons -->
  <link href="{{url('AdminLTE/css/ionicons.min.css')}}" rel="stylesheet">
  <!-- Theme style -->
  <link href="{{url('AdminLTE/css/AdminLTE.min.css')}}" rel="stylesheet">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link href="{{url('AdminLTE/css/_all-skins.min.css')}}" rel="stylesheet">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>NusaDaya</span>
    </a>
...
<!-- SlimScroll -->
<script src="{{url('AdminLTE/js/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
<script src="{{url('AdminLTE/js/fastclick.js')}}"></script>
<!-- AdminLTE App -->
